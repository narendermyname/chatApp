...
public class XPStyleTheme extends DefaultMetalTheme {
    ...
    private final ColorUIResource primary3 = new ColorUIResource(225, 225, 200); // Title Color
    ...
    private final ColorUIResource secondary3 = new ColorUIResource(236, 233,246); //Face Color
